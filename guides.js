...
const SCENARIO_GUIDES = {
  ...
  devil: {
    fa: _gw([
      _gs('معرفی و ترکیب', [
        'سناریوی شیطان نسخه الهام گرفته از Trouble Brewing در Blood on the Clocktower است. این سناریو برای یادگیری نقش های Clocktower مناسب است: اطلاعات واقعی زیاد دارد، اما مسمومیت، مستی و ثبت اشتباه می تواند بازیکنان را گمراه کند.',
        ...
        '<br /><br /><b>نکته برنامه:</b> نقش های Devil Townsfolk و Devil Minion فقط نقش پایه برای پر کردن چیدمان سفارشی هستند؛ نقش های رسمی سناریو همان ۲۲ نقش Trouble Brewing هستند.',
      ].join('')),
      ...
      _gs('شب معارفه در برنامه', [
        'در ابزار Flow، مرحله <b>Devil Intro Night</b> را باز کنید. این مرحله برای ثبت اطلاعات اولیه و راهنمایی گرداننده است.',
      ...
      _gs('ترتیب شب های عادی', [
        ...
        '<br /><b>۳. Imp:</b> یک بازیکن را برای مرگ انتخاب می کند. می تواند خودش را بکشد؛ در این صورت یک دستیار زنده به Imp جدید تبدیل می شود. اگر Soldier سالم هدف باشد، نمی میرد.',
        '<br /><b>۴. Ravenkeeper:</b> فقط اگر همان شب کشته شده باشد بیدار می شود و نقش یک بازیکن را می فهمد.',
        '<br /><b>۵. Empath:</b> عدد ۰، ۱ یا ۲ از دو همسایه زنده نزدیک خود می گیرد.',
        '<br /><b>۶. Fortune Teller:</b> دو بازیکن را انتخاب می کند و جواب بله/خیر می گیرد که آیا یکی از آن ها شیطان ثبت می شود یا نه. طعمه قرمز هم جواب بله می دهد.',
        '<br /><b>۷. Undertaker:</b> اگر امروز کسی با اعدام مرده باشد، نقش او را می فهمد.',
        '<br /><b>۸. Butler:</b> ارباب فردا را انتخاب می کند.',
        '<br /><b>۹. Spy:</b> دفتر کامل بازی را می بیند.',
      ].join('')),
      _gs('روز و اعدام', [
        ...
        '<br /><br /><b>Devil Day Actions در برنامه:</b> قبل از رای گیری روز، اگر Virgin یا Slayer در بازی است این مرحله را بررسی کنید.',
    ...
    en: _gw([
      _gs('Overview & Composition', [
        'Devil is the app version of the Blood on the Clocktower Trouble Brewing script. It is beginner-friendly Clocktower: good players get many clues, but poison, drunkenness, and false registration can make those clues unreliable.',
        ...
        '<br /><br /><b>App note:</b> Devil Townsfolk and Devil Minion are filler roles for custom table sizes. The official script roles are the 22 Trouble Brewing characters.',
      ].join('')),
      _gs('Moderator Setup', [
      ...
      _gs('App Intro Night', [
        'Open <b>Flow -> Devil Intro Night</b>. This step records setup information and first-night guidance.',
      ...
      _gs('Regular Night Order', [
        ...
        '<br /><b>3. Imp:</b> Chooses one player to die. The Imp may choose themself; if so, an alive Minion becomes the new Imp. A healthy Soldier does not die from the Demon attack.',
        '<br /><b>4. Ravenkeeper:</b> Only wakes if killed that night, then learns one player character.',
        '<br /><b>5. Empath:</b> Learns 0, 1, or 2 evil living neighbors.',
        '<br /><b>6. Fortune Teller:</b> Chooses two players and gets yes/no for whether either registers as the Demon. The red herring also causes yes.',
        '<br /><b>7. Undertaker:</b> If a player died by execution today, learns that character.',
        '<br /><b>8. Butler:</b> Chooses tomorrow master.',
        '<br /><b>9. Spy:</b> Sees the full grimoire.',
      ].join('')),
      _gs('Day & Execution', [
        ...
        '<br /><br /><b>Devil Day Actions in the app:</b> Check this Flow step before normal voting when Virgin or Slayer is in play.',
